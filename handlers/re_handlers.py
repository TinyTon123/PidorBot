...
# router.message.filter(F.text, F.chat.id == -786352119)  # -1002107056835 - Мэри рабочий


# Хендлеры для ответа на реплики
@router.message(re_functions.net_answer_filter, F.chat.id.in_({-1002107056835, -786352119}))
...
@router.message(re_functions.nit_answer_filter, F.chat.id.in_({-1002107056835, -786352119}))
...
@router.message(re_functions.no_answer_filter, F.chat.id.in_({-1002107056835, -786352119}))
...
@router.message(re_functions.nope_answer_filter, F.chat.id.in_({-1002107056835, -786352119}))
...
@router.message(re_functions.nein_answer_filter, F.chat.id.in_({-1002107056835, -786352119}))
...
@router.message(re_functions.yes_answer_filter, F.chat.id == -786352119)
...
@router.message(re_functions.da_answer_filter, F.chat.id == -786352119)
...
@router.message(re_functions.traktorista_answer_filter, F.chat.id == -786352119)
...
@router.message(re_functions.friday, F.chat.id == -786352119)
...
@router.message(re_functions.kak_dela_answer_filter, F.chat.id.in_({-1002107056835, -786352119}))
async def kak_dela_answer(message: types.Message) -> None:
    await message.answer(f"{replies['kak_dela']}")


@router.message(re_functions.v_smysle_answer_filter, F.chat.id == -786352119)
